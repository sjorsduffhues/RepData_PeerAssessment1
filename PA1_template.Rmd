...
```
The mean is `r meanSteps` the median is `r medianSteps` steps per day.
...
The `r maxSteps[,1]`th interval has the maximum average value of `r maxSteps[,2]` steps  
...
+ The new mean is `r newMeanSteps`, it was `r meanSteps`.  
+ The new median is `r newMedianSteps`, it was `r medianSteps`.  
